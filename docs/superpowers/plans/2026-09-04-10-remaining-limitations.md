...
public sealed class InsertPlacementTests
{
    ...
    {
        Transform placement = new(new XYZ(100, 200, 0), new XYZ(0, 0, 0), new XYZ(2, 3, 1));
    ...
    {
        Transform placement = new(new XYZ(5, 5, 0), new XYZ(0, 0, Math.PI / 2), new XYZ(3, 3, 3));
    ...
    {
        Transform placement = new(XYZ.Zero, XYZ.Zero, new XYZ(-2, 2, 2));
    ...
    {
        Transform placement = new(XYZ.Zero, XYZ.Zero, new XYZ(2, 5, 1));
    ...
    public void APlacementSeenEdgeOnIsNotASimilarity()
    {
        ...
        Transform placement = new(XYZ.Zero, new XYZ(Math.PI / 2, 0, 0), new XYZ(1, 1, 1));
